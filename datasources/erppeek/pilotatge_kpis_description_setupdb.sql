...
INSERT INTO pilotatge_kpis_description(
	...
	VALUES
        ...
        (12, 'Fraccionament: Número de factures_b', 'Num de factures que estan en pobresa energètica amb data venciment avui', '[("type", "=", "out_invoice"), ("invoice_id.pending_state.weight", ">", 0), ("pending_state", "ilike", "%fraccio"),("date_due", "<=", "__7_days_ago__" )]', 'giscedata.facturacio.factura', '{"type":"out_invoice"}', '', 'count', 'daily', 'int', 'Cobraments', NOW()),
...
-- FACTURES EN PROCEDIMENT DE TALL:  numero = 3 - 26 - 7 - 9 - (12) - 24
