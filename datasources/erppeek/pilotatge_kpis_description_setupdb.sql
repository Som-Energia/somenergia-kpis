...
INSERT INTO pilotatge_kpis_description(
	...
	VALUES
        ...
        (18, 'Indic CACs - Total CACs oberts/pendents_a', 'Total CACs oberts', '[("state","!=","draft")]', 'giscedata.atc', '{}', '', 'count', 'daily', 'int', 'Factura', NOW())
        --(18, 'Indic CACs - Total CACs oberts/pendents_b', 'Total CACs pendents', '[("state","!=","draft")]', 'giscedata.atc', '{', '', 'count', 'daily', 'int', 'Factura', NOW())
