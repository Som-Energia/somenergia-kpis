...
with DAG(dag_id='omie_get_price_hour_dag', start_date=datetime(2022,6,15), schedule_interval='0 14 * * *', catchup=True, tags=["Omie", "Extract"], default_args=args) as dag:
    ...
    task_branch_pull_ssh = build_branch_pull_ssh_task(dag=dag, task_name='omie_get_price_hour', repo_name=repo_name)
